...
* For the last 6 years, I've been part of the Centre for Transforming Maintenance through Data Science
:::
...
![](images/LeighTyers.png){fig-align="center" height="500px"}


## Over to you

* Your role at Alcoa/BHP?
...
## Data science at Alcoa/BHP: the present?

- predicting pipe degradation
- estimating the failure time distribution of idlers in the presence of censoring (and lots of missing data!)
- modelling and predicting conveyor belt wear
- computer vision/image analysis for assessing asset degradation
...
::: {style="font-size: 70%"}
::: {.incremental}
- Will LLMs/generative AI make understanding how to code and knowing the principles of data science obsolete?
    - No!

- Knowing how to code and understanding the principles means that you'll be less likely to be misled by LLMs and you'll be more effective and efficient.
:::
:::
...
::: {.column width="60%"}
![](images/AI_The_elephant_in_the_room.jpg){height="475px"}
:::
